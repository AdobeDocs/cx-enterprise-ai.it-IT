...
Adobe [Experience Platform Agent Orchestrator](https://experienceleague.adobe.com/it/docs/cx-enterprise-ai/experience-cloud-ai/home) potenzia le funzionalità di IA per l&#39;analisi degli agenti nelle applicazioni aziendali CX.
...
Nelle applicazioni esistenti, è possibile utilizzare il linguaggio naturale per istruire gli agenti Adobe Experience Platform tramite l&#39;interfaccia di conversazione in [Assistente AI](https://experienceleague.adobe.com/it/docs/cx-enterprise-ai/experience-cloud-ai/home). L’Assistente AI è disponibile sia nella visualizzazione a schermo intero che nella barra a destra.
...
| [Journey Agent](https://experienceleague.adobe.com/it/docs/cx-enterprise-ai/experience-cloud-ai/agents/ajo-agent) | Consente ai team di analizzare e ottimizzare rapidamente e su larga scala i percorsi di clienti multi-touch. | <ul><li>Adobe Journey Optimizer (edizioni B2B e B2C)</li></ul> | |
| [Agente di supporto del prodotto](https://experienceleague.adobe.com/it/docs/cx-enterprise-ai/experience-cloud-ai/agents/product-support) | Risolvi i problemi di supporto senza uscire dai flussi di lavoro, crea ticket di assistenza clienti e tieni traccia dell’avanzamento del caso tramite l’Assistente AI. | <ul><li>Real-Time CDP (edizioni B2B, B2C e B2P)</li><li>Adobe Journey Optimizer (edizioni B2B e B2C)</li><li>Customer Journey Analytics (edizioni B2B e B2C)</li><li>Adobe Experience Manager</li></ul> | |
| [Adobe Marketing Agent for Microsoft 365 Copilot](https://experienceleague.adobe.com/it/docs/cx-enterprise-ai/experience-cloud-ai/agents/ama-ms) | Collega Experience Platform direttamente al Copilot Microsoft 365. È possibile porre domande in linguaggio naturale nelle applicazioni Microsoft 365, ad esempio Team, Word, Powerpoint ed Excel, per recuperare immediatamente informazioni di marketing da Experience Platform senza interrompere il flusso di lavoro. | <ul><li> Adobe Agent Orchestrator con supporto per Audience Agent, Journey Agent, Customer Journey Analytics Data Insights, Experience Platform Operational Insights</li></ul> | |

## Applicazioni AI-first CX Enterprise {#ai-first-apps}

Le applicazioni AI-first sono create con IA generativa o agente come componente principale. Utilizzano l’intelligenza artificiale generativa o agentica per le attività chiave e le funzioni agentiche sono già incluse nella licenza dell’applicazione AI-first. Di conseguenza, non richiedono la licenza Experience Platform Agent Orchestrator.

Nella tabella seguente sono elencati gli agenti Experience Platform disponibili come applicazioni AI-first. Vengono abilitati concedendo in licenza le seguenti applicazioni AI-first:
