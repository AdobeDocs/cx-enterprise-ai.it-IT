...
| Applicazione coperta | L’Assistente IA (legacy) è un’implementazione specifica per l’applicazione. | Puoi utilizzare AI Assistant (Next-Gen) per un’esperienza di AI Assistant unificata in tutte le applicazioni Adobe Experience Cloud. |
...
Nell&#39;interfaccia della home page di Experience Cloud, seleziona **[!UICONTROL Assistente IA]** nella barra di navigazione a sinistra per avviare una visualizzazione a schermo intero dell&#39;Assistente AI.

+++Seleziona per visualizzare

![La home di Experience Cloud con l&#39;icona Assistente AI selezionata nel menu di navigazione a sinistra.](./images/ai-assistant/from-experience-cloud.png)

+++

Puoi anche avviare AI Assistant dalle home page di applicazioni Experience Cloud come Experience Platform, Adobe Journey Optimizer e Customer Journey Analytics. Passa alla home page del prodotto, quindi seleziona l&#39;icona **Assistente IA** dall&#39;intestazione superiore per avviare il pannello chat dell&#39;Assistente IA nella barra a destra.
