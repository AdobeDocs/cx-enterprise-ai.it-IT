...
| Architettura della piattaforma | L’Assistente IA (legacy) non è basato sullo stack di Agent Orchestrator. | L&#39;Assistente di intelligenza artificiale (di nuova generazione) è basato su [Adobe Experience Platform Agent Orchestrator](https://experienceleague.adobe.com/en/docs/cx-enterprise-ai/experience-cloud-ai/agents/agent-orchestrator), che abilita l&#39;estensibilità e il coordinamento avanzato tra le funzionalità. |
| Applicazione coperta | L’Assistente IA (legacy) è un’implementazione specifica per l’applicazione. | È possibile utilizzare AI Assistant (di nuova generazione) per un&#39;esperienza di AI Assistant unificata in tutte le applicazioni Adobe CX Enterprise. |
...
![Interfaccia principale dell&#39;Assistente AI a schermo intero.](./assets/ai-assistant/blank-home.png)
...
Nell&#39;interfaccia della home page di CX Enterprise, selezionare **[!UICONTROL Assistente AI]** dal menu di navigazione a sinistra per avviare una visualizzazione a schermo intero dell&#39;Assistente AI.

+++Seleziona per visualizzare

![La home di CX Enterprise con l&#39;icona Assistente AI selezionata nel menu di navigazione a sinistra.](./assets/ai-assistant/from-experience-cloud.png)

+++

È inoltre possibile avviare AI Assistant dalle home page delle applicazioni CX Enterprise, come Experience Platform, Adobe Journey Optimizer e Customer Journey Analytics. Passa alla home page del prodotto, quindi seleziona l&#39;icona **Assistente IA** dall&#39;intestazione superiore per avviare il pannello chat dell&#39;Assistente IA nella barra a destra.

+++Seleziona per visualizzare

![La pagina principale del prodotto con l&#39;icona Assistente AI selezionata nel menu di navigazione a sinistra.](./assets/ai-assistant/from-product.png)
...
![L&#39;Assistente AI a schermo intero.](./assets/ai-assistant/ui-home.png)
...
![L&#39;Assistente AI nella visualizzazione della barra](./assets/ai-assistant/rail-mode.png)
...
![Selezione della richiesta di individuazione dalla visualizzazione a schermo intero.](./assets/ai-assistant/inputs/discover.png)
...
![Pannello di individuazione dalla visualizzazione della barra.](./assets/ai-assistant/inputs/discover-rail.png)
...
![Il prompt di individuazione nella casella di input.](./assets/ai-assistant/inputs/question-input.png)
...
![Risposta dell&#39;Assistente di IA.](./assets/ai-assistant/inputs/answer.png)
...
![Pannello di ragionamento espanso in una risposta dell&#39;Assistente di intelligenza artificiale.](./assets/ai-assistant/inputs/reasoning-complete.png)
...
![Finestra dei suggerimenti correlati nell&#39;Assistente IA.](./assets/ai-assistant/inputs/related-suggestions.png)
...
![Elenco delle origini a cui fa riferimento l&#39;Assistente di IA.](./assets/ai-assistant/inputs/sources.png)
...
![Le icone miniature in alto e miniature in AI Assistant.](./assets/ai-assistant/inputs/feedback.png)
...
![Finestra di feedback miniature.](./assets/ai-assistant/inputs/thumbs-up.png)
...
![Finestra di feedback dettagliata per le miniature in alto.](./assets/ai-assistant/inputs/thumbs-up-detailed.png)
...
![Finestra di feedback miniature in basso.](./assets/ai-assistant/inputs/thumbs-down.png)
...
![Finestra di feedback dettagliata per miniature in basso.](./assets/ai-assistant/inputs/thumbs-down-detailed.png)
...
![Modalità di visualizzazione divisa nell&#39;Assistente IA.](./assets/ai-assistant/inputs/split-view.png)
...
![Finestra conversazioni nell&#39;Assistente di IA.](./assets/ai-assistant/conversations/select-conversations.png)

Per rivedere una conversazione precedente, selezionare l&#39;argomento di conversazione dall&#39;elenco fornito.

![Elenco delle conversazioni precedenti registrate nell&#39;Assistente di IA.](./assets/ai-assistant/conversations/revisit-conversation.png)

Per avviare una nuova conversazione, selezionare **[!UICONTROL Nuova conversazione]**.

![Opzione &quot;nuova conversazione&quot; selezionata.](./assets/ai-assistant/conversations/new-conversation.png)
...
![Icona impostazione contesto selezionata.](./assets/ai-assistant/inputs/context-selection.png)
...
| --- | --- | --- |
| App | L&#39;applicazione CX Enterprise a cui si riferisce la query. | Experience Platform, Journey Optimizer, Customer Journey Analytics, ecc. |
...
![Pannello &quot;Risposta da&quot; in cui è possibile configurare le origini informazioni.](./assets/ai-assistant/inputs/answer-from.png)
...
![Pulsante di completamento automatico dell&#39;oggetto e dei dati selezionato.](./assets/ai-assistant/autocomplete/autocomplete.png)
...
![I termini della query corrispondono alla risposta.](./assets/ai-assistant/autocomplete/query-terms.png)
...
![Strumenti di verifica SQL nell&#39;Assistente IA.](./assets/ai-assistant/autocomplete/verifications.png)
...
![Un grafico a barre visualizzato nell&#39;Assistente AI](./assets/ai-assistant/visualization/graph.png)
...
![Un grafico a linee sull&#39;Assistente AI.](./assets/ai-assistant/visualization/line.png)

>[!TAB Area]

Per visualizzare un grafico a superficie, selezionare **[!UICONTROL Proprietà]**, quindi selezionare **[!UICONTROL Area]**.

![Un grafico ad area sull&#39;Assistente AI.](./assets/ai-assistant/visualization/area.png)

>[!TAB A dispersione]

Per visualizzare un grafico a dispersione, selezionare **[!UICONTROL Proprietà]**, quindi selezionare **[!UICONTROL Dispersione]**.

![Un grafico a dispersione sull&#39;Assistente di intelligenza artificiale.](./assets/ai-assistant/visualization/scatter.png)

>[!TAB Anello]

Per visualizzare un grafico ad anello, selezionare **[!UICONTROL Proprietà]**, quindi selezionare **[!UICONTROL Anello]**.

![Un grafico ad anello nell&#39;Assistente IA.](./assets/ai-assistant/visualization/donut.png)
